...
import { ChevronLeft, ChevronRight, Bell, Settings, User as UserIcon, Home, Clock } from "lucide-react"
...
export function WeeklyCalendarView({ onAppointmentClick, userRole }: WeeklyCalendarViewProps) {
  ...
  const displayedAppointments = selectedDay ? getAppointmentsForDay(selectedDay) : []

  if (loading) {
    return (
      <div className="calendar-weekly-container" style={{display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '600px'}}>
    ...
    <div className="calendar-weekly-container">
      ...
      <div className="calendar-header">
        <div className="calendar-header-content">
          <div className="calendar-logo-nav">
            <div className="calendar-logo" onClick={goToHome}>ARVI VET</div>
          ...
          <div className="calendar-user-controls">
            ...
            <button className="calendar-home-button" onClick={goToHome}>
              <Home style={{width: '1rem', height: '1rem', marginRight: '0.25rem'}} />
              Inicio
            </button>
      ...
      <div className="calendar-controls">
        <div className="calendar-controls-content">
          ...
          <button className="calendar-week-button">
            Semana
          </button>
        </div>
      </div>
        ...
        <div className="calendar-main-content">
          <div className="calendar-layout">
            ...
            <div className="calendar-grid">
              ...
              {/* Time Rows */}
              <div className="calendar-time-rows" style={{ position: 'relative' }}>
                ...
                {timeSlots.map((hour) => (
                  <div key={hour} className="calendar-time-row">
                    <div className="calendar-time-label">
                      <span className={`calendar-time-text ${isCurrentTimeSlot(hour) ? 'calendar-current-time' : ''}`}>
                        {hour}
                      </span>
                    </div>
            ...
            <div className="calendar-sidebar">
              <div className="calendar-sidebar-title">
                {selectedDay ? (
                  <>
                    Citas del {format(selectedDay, "dd/MM/yyyy", { locale: es })}
                    <div className="calendar-appointments-count">
              ...
              <div className="calendar-appointments-list">
                {displayedAppointments.length > 0 ? (
                  ...
                  <div style={{ textAlign: 'center', color: '#9ca3af', fontSize: '0.875rem', marginTop: '2rem' }}>
                    {selectedDay ? 'No hay citas programadas para este día' : 'Haz clic en un día para ver las citas'}
                  </div>
                )}
              </div>
            </div>
